...
public class Main {
    ...
    /*
    * Searches through the array by first dividing into half
    * left-side -> low, right-side -> high
    * If the number we're looking for is equal to middle value, return the middle value
    * If the number we're looking for is less than the middle, work on the left side and repeat until we find our number
    * Other wise, work on the right side, repeat until answer is found.
    */
